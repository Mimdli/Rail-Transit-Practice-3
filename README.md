...
✅ **当前状态：320 个单元测试全部通过，GUI 与调度中心可正常运行。**
...
1. 打开「调度中心」页签，在不同车站添加列车。
2. 选中列车并设置主线往返交路。
3. 点击「发车」，观察列车目标站、区段占用和滚动进路锁闭。
4. 使用「扣车」「解除扣车」「紧急停车」验证调度命令。
5. 列车到达终端站后会自动换端，并按反方向继续运行。
